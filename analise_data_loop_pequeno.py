...
import a_loam_data_volta_posição as aloam_data
import kiss_icp_volta_posição as kiss_icp_data
import lego_loam_data_volta_posição as lego_loam_data
...
xy.set(xlim=(0, 5), xticks=np.arange(0, 5),
...
xy.legend()  
xy.set_title("Experiência Loop Pequeno - Odometria Registada dos Eixos X e Y")
...
cart_time[0].set(xlim=(0, 169), xticks=np.arange(1, 169, 3),
       ylim=(-0.1, 5.5), yticks=np.arange(0,5))       
cart_time[0].set_xlabel('Tempo Decorrido (seg)')
cart_time[0].set_ylabel('Eixo dos X ao longo do Tempo (m)')  
cart_time[0].legend()     
cart_time[0].set_title("Experiência Loop Pequeno - Odometria Registada ao Longo do Tempo sobre o Eixo dos X")
...
cart_time[1].set(xlim=(0, 169), xticks=np.arange(1, 169, 3),
       ylim=(-0.1, 3), yticks=np.arange(1,3))       
cart_time[1].set_xlabel('Tempo Decorrido (seg)')
cart_time[1].set_ylabel('Eixo dos Y ao longo do Tempo (m)')  
cart_time[1].legend()     
cart_time[1].set_title("Experiência Loop Pequeno - Odometria Registada ao Longo do Tempo sobre o Eixo dos Y")
...
cart_time[2].set(xlim=(0, 169), xticks=np.arange(1, 169, 3),
       ylim=(-0.05, 0.2), yticks=(-0.15, -0.1 , -0.05 , 0 , 0.05, 0.1 , 0.15))       
cart_time[2].set_xlabel('Tempo Decorrido (seg)')
cart_time[2].set_ylabel('Altura detetada pelo sensor (m)')  
cart_time[2].legend()     
cart_time[2].set_title("Experiência Loop Pequeno - Odometria Registada ao Longo do Tempo sobre o Eixo dos Z")
...
of.set(xlim=(-0.5,0.5), xticks = (-0.5,0,0.5),
       ylim=(-0.1,0.1) , yticks = (-0.2,-0.1,0,0.1,0.2))
of.legend()
of.set_xlabel('Offset da Linha Horizontal (m)')
of.set_ylabel('Offset da Linha Vertical (m)')
of.set_title("Experiência Loop Pequeno - Odometria Registada do Final")
...
dt_al[0].set_title("Experiência Loop Pequeno - Frequência Absoluta do Período de Tempo entre Tópicos de Odometria do A-LOAM")
dt_al[1].set_title("Experiência Loop Pequeno - Frequência Relativa do Período de Tempo entre Tópicos de Odometria do A-LOAM")
...
dt_kiss[0].set_title("Experiência Loop Pequeno - Frequência Absoluta do Período de Tempo entre Tópicos de Odometria do KISS-ICP")
dt_kiss[1].set_title("Experiência Loop Pequeno - Frequência Relativa do Período de Tempo entre Tópicos de Odometria do KISS-ICP")
...
dt_lego[0].set_title("Experiência Loop Pequeno - Frequência Absoluta do Período de Tempo entre Tópicos de Odometria do LeGO-LOAM")
dt_lego[1].set_title("Experiência Loop Pequeno - Frequência Relativa do Período de Tempo entre Tópicos de Odometria do LeGO-LOAM")
